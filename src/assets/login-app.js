 ...
 */var Ig;function Qx(){if(Ig)return Il;Ig=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,o,c){var d=null;if(c!==void 0&&(d=""+c),o.key!==void 0&&(d=""+o.key),"key"in o){c={};for(var p in o)p!=="key"&&(c[p]=o[p])}else c=o;return o=c.ref,{$$typeof:s,type:r,key:d,ref:o!==void 0?o:null,props:c}}return Il.Fragment=e,Il.jsx=i,Il.jsxs=i,Il}var Bg;function Jx(){return Bg||(Bg=1,ld.exports=Qx()),ld.exports}var He=Jx(),od={exports:{}},rt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Xg;function n2(){if(Xg)return Nn;Xg=1;var s=zh();function e(m){var h="https://react.dev/errors/"+m;if(1<arguments.length){h+="?args[]="+encodeURIComponent(arguments[1]);for(var v=2;v<arguments.length;v++)h+="&args[]="+encodeURIComponent(arguments[v])}return"Minified React error #"+m+"; visit "+h+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var r={d:{f:i,r:function(){throw Error(e(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},o=Symbol.for("react.portal");function c(m,h,v){var x=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:o,key:x==null?null:""+x,children:m,containerInfo:h,implementation:v}}var d=s.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function p(m,h){if(m==="font")return"";if(typeof h=="string")return h==="use-credentials"?h:""}return Nn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=r,Nn.createPortal=function(m,h){var v=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!h||h.nodeType!==1&&h.nodeType!==9&&h.nodeType!==11)throw Error(e(299));return c(m,h,null,v)},Nn.flushSync=function(m){var h=d.T,v=r.p;try{if(d.T=null,r.p=2,m)return m()}finally{d.T=h,r.p=v,r.d.f()}},Nn.preconnect=function(m,h){typeof m=="string"&&(h?(h=h.crossOrigin,h=typeof h=="string"?h==="use-credentials"?h:"":void 0):h=null,r.d.C(m,h))},Nn.prefetchDNS=function(m){typeof m=="string"&&r.d.D(m)},Nn.preinit=function(m,h){if(typeof m=="string"&&h&&typeof h.as=="string"){var v=h.as,x=p(v,h.crossOrigin),g=typeof h.integrity=="string"?h.integrity:void 0,y=typeof h.fetchPriority=="string"?h.fetchPriority:void 0;v==="style"?r.d.S(m,typeof h.precedence=="string"?h.precedence:void 0,{crossOrigin:x,integrity:g,fetchPriority:y}):v==="script"&&r.d.X(m,{crossOrigin:x,integrity:g,fetchPriority:y,nonce:typeof h.nonce=="string"?h.nonce:void 0})}},Nn.preinitModule=function(m,h){if(typeof m=="string")if(typeof h=="object"&&h!==null){if(h.as==null||h.as==="script"){var v=p(h.as,h.crossOrigin);r.d.M(m,{crossOrigin:v,integrity:typeof h.integrity=="string"?h.integrity:void 0,nonce:typeof h.nonce=="string"?h.nonce:void 0})}}else h==null&&r.d.M(m)},Nn.preload=function(m,h){if(typeof m=="string"&&typeof h=="object"&&h!==null&&typeof h.as=="string"){var v=h.as,x=p(v,h.crossOrigin);r.d.L(m,v,{crossOrigin:x,integrity:typeof h.integrity=="string"?h.integrity:void 0,nonce:typeof h.nonce=="string"?h.nonce:void 0,type:typeof h.type=="string"?h.type:void 0,fetchPriority:typeof h.fetchPriority=="string"?h.fetchPriority:void 0,referrerPolicy:typeof h.referrerPolicy=="string"?h.referrerPolicy:void 0,imageSrcSet:typeof h.imageSrcSet=="string"?h.imageSrcSet:void 0,imageSizes:typeof h.imageSizes=="string"?h.imageSizes:void 0,media:typeof h.media=="string"?h.media:void 0})}},Nn.preloadModule=function(m,h){if(typeof m=="string")if(h){var v=p(h.as,h.crossOrigin);r.d.m(m,{as:typeof h.as=="string"&&h.as!=="script"?h.as:void 0,crossOrigin:v,integrity:typeof h.integrity=="string"?h.integrity:void 0})}else r.d.m(m)},Nn.requestFormReset=function(m){r.d.r(m)},Nn.unstable_batchedUpdates=function(m,h){return m(h)},Nn.useFormState=function(m,h,v){return d.H.useFormState(m,h,v)},Nn.useFormStatus=function(){return d.H.useHostTransitionStatus()},Nn.version="19.2.0",Nn}var kg;function i2(){if(kg)return dd.exports;kg=1;function s(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(s)}catch(e){console.error(e)}}return s(),dd.exports=n2(),dd.exports}/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ya,depthTest:!1,depthWrite:!1})}function XE(s,e,i){const r=new Float32Array(Pr),o=new oe(0,1,0);return new Ki({name:"SphericalGaussianBlur",defines:{n:Pr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:tu(),fragmentShader:`
	...
	`}class z_ extends Wi{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const r={width:e,height:e,depth:1},o=[r,r,r,r,r,r];this.texture=new N_(o),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const r={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},o=new $l(5,5,5),c=new Ki({name:"CubemapFromEquirect",uniforms:ks(r.uniforms),vertexShader:r.vertexShader,fragmentShader:r.fragmentShader,side:Zn,blending:ya});c.uniforms.tEquirect.value=i;const d=new Yi(o,c),p=i.minFilter;return i.minFilter===Fr&&(i.minFilter=ln),new KS(1,10,this).update(e,d),i.minFilter=p,d.geometry.dispose(),d.material.dispose(),this}clear(e,i=!0,r=!0,o=!0){const c=e.getRenderTarget();for(let d=0;d<6;d++)e.setRenderTarget(this,d),e.clear(i,r,o);e.setRenderTarget(c)}}function kE(s){let e=new WeakMap,i=new WeakMap,r=null;function o(g,y=!1){return g==null?null:y?d(g):c(g)}function c(g){if(g&&g.isTexture){const y=g.mapping;if(y===hd||y===pd)if(e.has(g)){const T=e.get(g).texture;return p(T,g.mapping)}else{const T=g.image;if(T&&T.height>0){const D=new z_(T.height);return D.fromEquirectangularTexture(s,g),e.set(g,D),g.addEventListener("dispose",h),p(D.texture,g.mapping)}else return null}}return g}function d(g){if(g&&g.isTexture){const y=g.mapping,T=y===hd||y===pd,D=y===Br||y===Gs;if(T||D){let E=i.get(g);const S=E!==void 0?E.texture.pmremVersion:0;if(g.isRenderTargetTexture&&g.pmremVersion!==S)return r===null&&(r=new A1(s)),E=T?r.fromEquirectangular(g,E):r.fromCubemap(g,E),E.texture.pmremVersion=g.pmremVersion,i.set(g,E),E.texture;if(E!==void 0)return E.texture;{const z=g.image;return T&&z&&z.height>0||D&&z&&m(z)?(r===null&&(r=new A1(s)),E=T?r.fromEquirectangular(g):r.fromCubemap(g),E.texture.pmremVersion=g.pmremVersion,i.set(g,E),g.addEventListener("dispose",v),E.texture):null}}}return g}function p(g,y){return y===hd?g.mapping=Br:y===pd&&(g.mapping=Gs),g}function m(g){let y=0;const T=6;for(let D=0;D<T;D++)g[D]!==void 0&&y++;return y===T}function h(g){const y=g.target;y.removeEventListener("dispose",h);const T=e.get(y);T!==void 0&&(e.delete(y),T.dispose())}function v(g){const y=g.target;y.removeEventListener("dispose",v);const T=i.get(y);T!==void 0&&(i.delete(y),T.dispose())}function x(){e=new WeakMap,i=new WeakMap,r!==null&&(r.dispose(),r=null)}return{get:o,dispose:x}}function WE(s){const e={};function i(r){if(e[r]!==void 0)return e[r];const o=s.getExtension(r);return e[r]=o,o}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const o=i(r);return o===null&&Is("WebGLRenderer: "+r+" extension not supported."),o}}}function qE(s,e,i,r){const o={},c=new WeakMap;function d(x){const g=x.target;g.index!==null&&e.remove(g.index);for(const T in g.attributes)e.remove(g.attributes[T]);g.removeEventListener("dispose",d),delete o[g.id];const y=c.get(g);y&&(e.remove(y),c.delete(g)),r.releaseStatesOfGeometry(g),g.isInstancedBufferGeometry===!0&&delete g._maxInstanceCount,i.memory.geometries--}function p(x,g){return o[g.id]===!0||(g.addEventListener("dispose",d),o[g.id]=!0,i.memory.geometries++),g}function m(x){const g=x.attributes;for(const y in g)e.update(g[y],s.ARRAY_BUFFER)}function h(x){const g=[],y=x.index,T=x.attributes.position;let D=0;if(T===void 0)return;if(y!==null){const z=y.array;D=y.version;for(let B=0,w=z.length;B<w;B+=3){const F=z[B+0],C=z[B+1],L=z[B+2];g.push(F,C,C,L,L,F)}}else{const z=T.array;D=T.version;for(let B=0,w=z.length/3-1;B<w;B+=3){const F=B+0,C=B+1,L=B+2;g.push(F,C,C,L,L,F)}}const E=new(T.count>=65535?U_:D_)(g,1);E.version=D;const S=c.get(x);S&&e.remove(S),c.set(x,E)}function v(x){const g=c.get(x);if(g){const y=x.index;y!==null&&g.version<y.version&&h(x)}else h(x);return c.get(x)}return{get:p,update:m,getWireframeAttribute:v}}function ZE(s,e,i){let r;function o(x){r=x}let c,d;function p(x){c=x.type,d=x.bytesPerElement}function m(x,g){s.drawElements(r,g,c,x*d),i.update(g,r,1)}function h(x,g,y){y!==0&&(s.drawElementsInstanced(r,g,c,x*d,y),i.update(g,r,y))}function v(x,g,y){if(y===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,g,0,c,x,0,y);let D=0;for(let E=0;E<y;E++)D+=g[E];i.update(D,r,1)}this.setMode=o,this.setIndex=p,this.render=m,this.renderInstances=h,this.renderMultiDraw=v}function YE(s){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(c,d,p){switch(i.calls++,d){case s.TRIANGLES:i.triangles+=p*(c/3);break;case s.LINES:i.lines+=p*(c/2);break;case s.LINE_STRIP:i.lines+=p*(c-1);break;case s.LINE_LOOP:i.lines+=p*c;break;case s.POINTS:i.points+=p*c;break;default:Et("WebGLInfo: Unknown draw mode:",d);break}}function o(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:o,update:r}}function KE(s,e,i){const r=new WeakMap,o=new sn;function c(d,p,m){const h=d.morphTargetInfluences,v=p.morphAttributes.position||p.morphAttributes.normal||p.morphAttributes.color,x=v!==void 0?v.length:0;let g=r.get(p);if(g===void 0||g.count!==x){let k=function(){b.dispose(),r.delete(p),p.removeEventListener("dispose",k)};var y=k;g!==void 0&&g.texture.dispose();const T=p.morphAttributes.position!==void 0,D=p.morphAttributes.normal!==void 0,E=p.morphAttributes.color!==void 0,S=p.morphAttributes.position||[],z=p.morphAttributes.normal||[],B=p.morphAttributes.color||[];let w=0;T===!0&&(w=1),D===!0&&(w=2),E===!0&&(w=3);let F=p.attributes.position.count*w,C=1;F>e.maxTextureSize&&(C=Math.ceil(F/e.maxTextureSize),F=e.maxTextureSize);const L=new Float32Array(F*C*4*x),b=new R_(L,F,C,x);b.type=Gi,b.needsUpdate=!0;const O=w*4;for(let G=0;G<x;G++){const J=S[G],he=z[G],ve=B[G],j=F*C*4*G;for(let I=0;I<J.count;I++){const V=I*O;T===!0&&(o.fromBufferAttribute(J,I),L[j+V+0]=o.x,L[j+V+1]=o.y,L[j+V+2]=o.z,L[j+V+3]=0),D===!0&&(o.fromBufferAttribute(he,I),L[j+V+4]=o.x,L[j+V+5]=o.y,L[j+V+6]=o.z,L[j+V+7]=0),E===!0&&(o.fromBufferAttribute(ve,I),L[j+V+8]=o.x,L[j+V+9]=o.y,L[j+V+10]=o.z,L[j+V+11]=ve.itemSize===4?o.w:1)}}g={count:x,texture:b,size:new wt(F,C)},r.set(p,g),p.addEventListener("dispose",k)}if(d.isInstancedMesh===!0&&d.morphTexture!==null)m.getUniforms().setValue(s,"morphTexture",d.morphTexture,i);else{let T=0;for(let E=0;E<h.length;E++)T+=h[E];const D=p.morphTargetsRelative?1:1-T;m.getUniforms().setValue(s,"morphTargetBaseInfluence",D),m.getUniforms().setValue(s,"morphTargetInfluences",h)}m.getUniforms().setValue(s,"morphTargetsTexture",g.texture,i),m.getUniforms().setValue(s,"morphTargetsTextureSize",g.size)}return{update:c}}function QE(s,e,i,r,o){let c=new WeakMap;function d(h){const v=o.render.frame,x=h.geometry,g=e.get(h,x);if(c.get(g)!==v&&(e.update(g),c.set(g,v)),h.isInstancedMesh&&(h.hasEventListener("dispose",m)===!1&&h.addEventListener("dispose",m),c.get(h)!==v&&(i.update(h.instanceMatrix,s.ARRAY_BUFFER),h.instanceColor!==null&&i.update(h.instanceColor,s.ARRAY_BUFFER),c.set(h,v))),h.isSkinnedMesh){const y=h.skeleton;c.get(y)!==v&&(y.update(),c.set(y,v))}return g}function p(){c=new WeakMap}function m(h){const v=h.target;v.removeEventListener("dispose",m),r.releaseStatesOfObject(v),i.remove(v.instanceMatrix),v.instanceColor!==null&&i.remove(v.instanceColor)}return{update:d,dispose:p}}const JE={[f_]:"LINEAR_TONE_MAPPING",[d_]:"REINHARD_TONE_MAPPING",[h_]:"CINEON_TONE_MAPPING",[p_]:"ACES_FILMIC_TONE_MAPPING",[g_]:"AGX_TONE_MAPPING",[__]:"NEUTRAL_TONE_MAPPING",[m_]:"CUSTOM_TONE_MAPPING"};function jE(s,e,i,r,o,c){const d=new Wi(e,i,{type:s,depthBuffer:o,stencilBuffer:c,samples:r?4:0,depthTexture:o?new Xs(e,i):void 0}),p=new Wi(e,i,{type:ba,depthBuffer:!1,stencilBuffer:!1}),m=new Qi;m.setAttribute("position",new Di([-1,3,0,-1,-1,0,3,-1,0],3)),m.setAttribute("uv",new Di([0,2,0,0,2,0],2));const h=new GS({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
#define LOW_PRECISION`),e}const rb={[zc]:"SHADOWMAP_TYPE_PCF",[ql]:"SHADOWMAP_TYPE_VSM"};function sb(s){return rb[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const lb={[Br]:"ENVMAP_TYPE_CUBE",[Gs]:"ENVMAP_TYPE_CUBE",[jc]:"ENVMAP_TYPE_CUBE_UV"};function ob(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":lb[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const cb={[Gs]:"ENVMAP_MODE_REFRACTION"};function ub(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":cb[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const fb={[u_]:"ENVMAP_BLENDING_MULTIPLY",[Q2]:"ENVMAP_BLENDING_MIX",[J2]:"ENVMAP_BLENDING_ADD"};function db(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":fb[s.combine]||"ENVMAP_BLENDING_NONE"}function hb(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function pb(s,e,i,r){const o=s.getContext(),c=i.defines;let d=i.vertexShader,p=i.fragmentShader;const m=sb(i),h=ob(i),v=ub(i),x=db(i),g=hb(i),y=J3(i),T=j3(c),D=o.createProgram();let E,S,z=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+S);const B=z+E+d,w=z+S+p,F=F1(o,o.VERTEX_SHADER,B),C=F1(o,o.FRAGMENT_SHADER,w);o.attachShader(D,F),o.attachShader(D,C),i.index0AttributeName!==void 0?o.bindAttribLocation(D,0,i.index0AttributeName):i.hasPositionAttribute===!0&&o.bindAttribLocation(D,0,"position"),o.linkProgram(D);function L(G){if(s.debug.checkShaderErrors){const J=o.getProgramInfoLog(D)||"",he=o.getShaderInfoLog(F)||"",ve=o.getShaderInfoLog(C)||"",j=J.trim(),I=he.trim(),V=ve.trim();let $=!0,ge=!0;if(o.getProgramParameter(D,o.LINK_STATUS)===!1)if($=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(o,D,F,C);else{const be=B1(o,F,"vertex"),N=B1(o,C,"fragment");Et("WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(D,o.VALIDATE_STATUS)+`
